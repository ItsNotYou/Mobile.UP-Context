define(['./RuleEngine', './nools', 'jquery', './contactJS', 'widgets', 'interpreters',
    './parser'], function(RuleEngine, nools, $, contactJS, widgets, interpreters) {
    return (function() {
        ...
        ContextDetector.prototype.extractContextInformationFromAdaptationRules = function(adaptationRules) {
            if (this._engine == RuleEngine.NOOLS) {
                ...
                adaptationRules.forEach(function(theRule) {
